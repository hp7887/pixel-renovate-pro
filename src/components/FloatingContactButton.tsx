...
export const FloatingContactButton = () => {
  ...
  return (
    <>
      <button
        onClick={openMenu}
        className="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-primary to-primary-glow shadow-elegant hover:shadow-glow transition-all duration-300 animate-pulse hover:animate-none hover:scale-110"
