...
const mainReviews = [
  {
    ...
    cons: "Пару раз были небольшие задержки с материалами, но прораб сразу решал вопрос.",
  ...
  },
  {
    ...
    cons: "Иногда был сильный шум, но нас предупреждали заранее. В целом терпимо.",
  ...
  },
  {
    ...
    cons: "Пришлось пару раз самому докупать мелочи типа саморезов. Но это мелочи.",
  ...
  },
  {
    ...
    cons: "Пару раз прораб опаздывал на встречи минут на 15-20, но потом все наверстывал.",
  ...
  },
  {
    ...
    cons: "Немного затянулись со сроками, но качество того стоило.",
...
const additionalReviews = [
  {
    ...
    cons: "Один раз привезли не те обои, пришлось ждать пару дней замены.",
  ...
  },
  {
    ...
    cons: "Первые замеры были неточные, пришлось переделывать.",
  ...
  },
  {
    ...
    cons: "Иногда было пыльно, но это нормально для ремонта.",
    project: "1-комн. квартира, 38 м²",
    initials: "ОИ"
  },
  {
    ...
    cons: "Ошиблись со смесителем, но быстро исправили.",
  ...
  },
  {
    ...
    cons: "Пару раз были небольшие задержки, но ничего критичного.",
  ...
  },
  {
    ...
    cons: "Задержки со сроками из-за проблем с координацией бригад.",
  ...
  },
  {
    ...
    cons: "Немного запаха от краски оставалось, но это нормально.",
    project: "1-комн. квартира, 35 м²",
    initials: "ТВ"
  },
  {
    name: "Денис Михайлович",
    date: "25.08.2024",
    rating: 4,
    ...
    cons: "Упустили момент с дополнительной розеткой, пришлось доделывать.",
  ...
  },
  {
    ...
    cons: "Небольшие задержки с поставкой материалов.",
  ...
  },
  {
    ...
    cons: "Один раз бригада опоздала на объект, но предупредили заранее.",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {!showForm ? (
            ...
            <Card className="mb-12 border-2 border-cyan-500/20">
          ...
          {!showAllReviews && (
            <div className="mt-8 text-center">
              ...
              >
                Смотреть все отзывы ({additionalReviews.length}+)
              </Button>
            </div>
          )}
        </div>
