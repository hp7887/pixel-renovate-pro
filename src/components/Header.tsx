        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <div className="hidden xl:flex items-center space-x-2 text-gray-800 font-semibold">
              ...
              <a href="tel:+78122099885" className="hover:text-primary transition-colors text-sm">
                8 812 209-98-85
              </a>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <Button 
                ...
                variant="outline"
                className="p-2 border-primary text-primary hover:bg-primary hover:text-white h-9 w-9"
                onClick={() => window.open('https://t.me/dsremontBot', '_blank')}
              >
          ...
          <nav className="lg:hidden mt-4 pb-4 border-t pt-4 animate-fade-in">
            <div className="flex flex-col space-y-3">
              ...
              <div className="border-t pt-3 mt-3 space-y-3">
                <a href="tel:+78122099885" className="flex items-center space-x-2 text-gray-800 hover:text-primary transition-colors px-2">
                  <Phone className="w-4 h-4" />
                  <span className="font-semibold text-sm">8 812 209-98-85</span>
                </a>
                ...
                <div className="flex items-center space-x-2 px-2">
                  ...
                  <Button 
                    ...
                    className="flex-1 border-primary text-primary hover:bg-primary hover:text-white"
                    onClick={() => {
                      window.open('https://t.me/dsremontBot', '_blank');
                      setIsMobileMenuOpen(false);
                    }}
                  >
