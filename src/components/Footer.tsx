          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className={`transform transition-all duration-700 ${
              ...
              <ul className="space-y-2 md:space-y-3">
                ...
                <li><Link to="/materials-calculator" className="text-gray-300 hover:text-yellow-400 transition-all duration-300 ease-in-out hover:translate-x-2 inline-block text-sm md:text-base">Калькулятор материалов</Link></li>
                ...
                <li><Link to="/partnership" className="text-gray-300 hover:text-yellow-400 transition-all duration-300 ease-in-out hover:translate-x-2 inline-block text-sm md:text-base">Сотрудничество</Link></li>
            ...
            <div className={`sm:col-span-2 lg:col-span-1 transform transition-all duration-700 ${
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex items-start gap-2 md:gap-3 group">
                  ...
                  <div>
                    <a href="mailto:dsremont@inbox.ru" className="font-medium text-white hover:text-yellow-400 transition-colors text-sm md:text-base break-all">
                      dsremont@inbox.ru
                    </a>
