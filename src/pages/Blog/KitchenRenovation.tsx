            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700">
                  Мы выполним ремонт кухни под ключ: от дизайн-проекта до установки последней ручки на шкафу. Соблюдаем сроки, работаем по договору с гарантией 3 года. Помогаем с выбором материалов и техники.
                </p>
              </section>
