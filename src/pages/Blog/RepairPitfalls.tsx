            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700">
                  Наша компания работает по прозрачной схеме: детальная смета, договор с четкими сроками, поэтапная оплата, гарантия 1 год. Мы заранее проводим техническую экспертизу и предупреждаем обо всех возможных рисках.
                </p>
              </section>
