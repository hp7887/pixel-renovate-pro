          ...
          <div className="max-w-4xl mx-auto space-y-8 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mb-4">
                ...
                РемСтрой (далее — Исполнитель) и пользователями сайта (далее — Заказчик).
              </p>
              <p>
                Используя сайт и сервисы РемСтрой, вы принимаете условия данного Соглашения в полном объеме. 
