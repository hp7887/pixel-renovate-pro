        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
              <p>
                Компания РемСтрой была основана в 2009 году группой энтузиастов, которые хотели 
              ...
              <p>
                Сегодня РемСтрой - это современная компания, которая объединяет опыт, технологии 
