...
const articles = [
  {
    id: 1,
    slug: "okna-v-kvartire",
    title: "Окна в квартире: выбор, установка, утепление и отделка откосов",
    excerpt: "Полный гид по окнам: выбор стеклопакетов, профилей ПВХ и алюминия, установка по ГОСТу, утепление, отделка откосов. Монтаж от 4500₽ в СПб.",
  ...
  },
  {
    ...
    title: "Напольные покрытия: полное руководство по выбору и укладке",
    excerpt: "Все о напольных покрытиях: ламинат, паркет, плитка, линолеум, наливные полы. Сравнение характеристик, цены, технология укладки.",
  ...
  },
  {
    id: 3,
    slug: "dizayn-spalni",
    title: "Дизайн и ремонт спальни: создаем идеальное место для отдыха",
    excerpt: "Полное руководство по дизайну и ремонту спальни: планировка, выбор цветов, освещение, материалы. Создайте комфортное пространство для сна.",
  ...
  {
    id: 4,
    slug: "sroki-remonta-kvartiry",
    title: "Сроки ремонта квартиры: реальные цифры и факторы влияния",
    excerpt: "Реальные сроки ремонта в СПб: косметический от 2 недель, капитальный 2-4 месяца. Этапы работ, факторы влияния, как ускорить процесс без потери качества.",
  ...
  {
    id: 2,
    slug: "remont-ofisnyh-pomeshcheniy",
    title: "Ремонт офисных помещений: особенности и цены в СПб 2025",
    excerpt: "Комплексный ремонт офисов под ключ: планировка, зонирование, отделка, коммуникации. Соблюдение норм, сроки 3-8 недель. От 4500₽/м².",
    image: blogOfficeRenovation,
    date: "13 марта 2025",
    readTime: "15 мин"
  },
  {
