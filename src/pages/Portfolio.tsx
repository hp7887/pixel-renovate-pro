...
const projects = [
  {
    id: 10,
    images: [project10img3, project10img1, project10img2, project10img4],
    imageLabels: ["Стена с рейками и зеркалом", "Декоративные ниши с подсветкой", "Прихожая с мебелью", "Холл с многоуровневым потолком"],
    title: "Квартира в ЖК «Парадный квартал»",
    area: "95 м²",
    type: "Дизайнерский ремонт",
    description: "Элегантная квартира с современным дизайном. Акцентная стена с деревянными рейками и большим зеркалом, декоративные ниши с подсветкой, стильная прихожая с встроенной мебелью, просторный холл с эффектным многоуровневым потолком.",
    year: "2024"
  },
  {
    id: 7,
